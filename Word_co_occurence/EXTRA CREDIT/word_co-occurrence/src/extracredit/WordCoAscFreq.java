...
public class WordCoAscFreq extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    job.setJarByClass(WordCoAscFreq.class);
  ...
  public static void main(String[] args) throws Exception {
    int exitCode = ToolRunner.run(new Configuration(), new WordCoAscFreq(), args);
